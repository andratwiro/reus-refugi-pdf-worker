...
const CASES: TestCase[] = [
  { fixture: 'abderrahim.json', notes: 'Cas real RR-001. DA 21ª Vulnerabilitat. Codis estimats.' },
  {
    fixture: 'bagar.json',
  ...
  { fixture: 'dayner.json', notes: 'Cas real RR-003. DA 20ª Sol·licitant PI. Codis estimats.' },
